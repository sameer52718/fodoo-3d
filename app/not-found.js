      ...
      >
        ...
        <div className="relative">
          <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
            <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-purple-500 rounded-full"></div>
          </div>
        </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            <button
              className="flex items-center px-6 py-3 bg-purple-500 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 group"
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-1">Browse all pages</p>
              </a>
              <a
                href="#"
                className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200"
              >
                ...
                <p className="text-sm text-gray-500 mt-1">Read our newest content</p>
              </a>
            </div>
          </div>
        </div>
